...
public class FinshItem {
    ...
    public List<ArticalImage> article_image;
    ...
    public String article_comment_type;
    ...
    public FinshItem(String article_id, String article_category, String article_title, String article_content, List<ArticalImage> article_image, String display, String creator, String created, String modifier, String modified, Object delete_time, CategoryBean category, Object comment,String username,String nickname) {
    ...
    public class ArticalImage{


        /**
         * article_image : /upload/active/20171216/628cdc773ee45c7c57d44f287e852a54.jpg
         * attr : 0
         */
    ...
    public String getArticle_contentMine(){
        if(article_content!=null) {
            if (article_content.length() > 65) {
                return article_content.substring(0, 65) + "...";
            } else {
    ...
    public boolean isShow(){
        if(getArticle_contentMine().endsWith("...")){
            return true;
        }else {
            return false;
        }
    ...
    public List<ArticalImage> getArticle_image() {
        return article_image;
    }

    public void setArticle_image(List<ArticalImage> article_image) {
        this.article_image = article_image;
    }
    ...
    public String getArticle_comment_type() {
        return article_comment_type;
    }

    public void setArticle_comment_type(String article_comment_type) {
        this.article_comment_type = article_comment_type;
    }
