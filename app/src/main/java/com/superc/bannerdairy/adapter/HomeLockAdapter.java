...
public class HomeLockAdapter extends RecyclerView.Adapter  {
     ...
     */
    public HomeLockAdapter(Context context, List<TreasureItem> dataList, int layoutId, int variableId) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ItemTreasureBinding itemBinding = (ItemTreasureBinding) binding;
        ...
        itemBinding.ivBuyNum.setText(mDataList.get(position).getModifier()+"付款");
