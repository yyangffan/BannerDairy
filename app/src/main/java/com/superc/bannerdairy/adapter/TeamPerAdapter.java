...
import com.superc.bannerdairy.databinding.ItemTeamProBinding;
...
public class TeamPerAdapter  extends RecyclerView.Adapter {
    protected List<TeamProItem> mDataList;// 数据列表
     ...
     */
    public TeamPerAdapter(Context context, List<TeamProItem> dataList, int layoutId, int variableId) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ItemTeamProBinding itemBinding = (ItemTeamProBinding) binding;
...
//        itemBinding.textView15.setText(mDataList.get(position).getGroup_performance());
        String buynumber=mDataList.get(position).getGroup_buy_number();
        float buy_number=Float.parseFloat(buynumber==null||buynumber.equals("")?"0":buynumber);
        itemBinding.textView15.setText(mDecimalFormat.format(buy_number));
        ...
        if(mDataList.get(position).getAgency_level()!=null) {
            switch (Integer.parseInt(mDataList.get(position).getAgency_level())) {
                ...
                case 0:
                    itemBinding.textView18.setText(R.string.zhu);
                    break;
                case 1:
                    itemBinding.textView18.setText(R.string.te);
                    break;
                case 2:
                    itemBinding.textView18.setText(R.string.men);
                    break;
                case 3:
                    itemBinding.textView18.setText(R.string.xian);
                    break;
                case 4:
                    itemBinding.textView18.setText(R.string.shi);
                    break;
                case 5:
                    itemBinding.textView18.setText(R.string.sheng);
                    break;
            }
        }
