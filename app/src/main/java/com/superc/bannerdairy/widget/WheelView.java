...
package com.superc.bannerdairy.widget;
...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            itemsPaint.setTextSize(context.getResources().getDimension(R.dimen.text_size_so_small));
...
//					| Paint.FAKE_BOLD_TEXT_FLAG | Paint.DITHER_FLAG);
            ...
            valuePaint.setTextSize(context.getResources().getDimension(R.dimen.text_size_so_small));
